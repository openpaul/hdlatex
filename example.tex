...
\documentclass[%
 ...
 twoside,        % Für zweiseitigen Druck (alt. oneside)
 thesis,         % thesis, summary, projectproposal, normal
 impberklaerung, % Wechsel zwischen zwei Erklärungen (erntferne die option für die  Alternative )
 bachelor        % bachelor master or remove
]{hdthesis}   % hdprotokoll oder hdthesis
% -------------------------------------------------------------------------
...
\Aname{Prof. Dumbledore}        % Erstgutachter
\Aabteilung{Head of Hogwards}           % Abteilung
\Ainstitute{Hogwarts School of Witchcraft and Wizardry}               % Institut

\Bname{}        % Zweitgutachter
